...
export default class StateController {
  ...
  onDataChanged(data) {
    ...
    if (this.app.state !== null) {
      this.app.state.onDistrictChanged =
        this.app.state.onDistrictChanged.bind(this) // TODO: Description!
    }
  ...
  renderAgeSection() {
    ...
    items.forEach((item) => {
      ...
      const d = this.app.getNestedValue(
        this.app.model.districtObject,
        item.path
      )
