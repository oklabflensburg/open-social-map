...
```sql
 id | year | under_18 | 18_to_under_30 | 30_to_under_45 | 45_to_under_65 | 65_to_under_80 | 80_and_above
----+------+----------+----------------+----------------+----------------+----------------+--------------
...
```sql
 id | year | district_id | total | under_18 | 18_to_under_30 | 30_to_under_45 | 45_to_under_65 | 65_to_under_80 | 80_and_older | 0_to_under_7 | 60_and_older
----+------+-------------+-------+----------+----------------+----------------+----------------+----------------+--------------+--------------+--------------
